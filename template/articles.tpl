            ...
            <div class="row justify-content-center" id="navbar">
                <nav class="navbar navbar-dark row navbar-expand-sm">
                    ...
                    <button class="navbar-toggler " type="button" data-toggle="collapse" data-target="#navbarContent" aria-controls="navbarContent" aria-expanded="false" aria-label="Toggle navigation">
                        ...
                        <img class="img" id="logo-burger" src="assets/media/image-index/japan-evasion-logo.png" alt="logo japan-evasion">
                    </button>
                    ...
                    <div class="navburger collapse navbar-collapse" id="navbarContent">
                        ...
                        <ul class="navbar-nav align-items-center">
                            ...
                            <li class="nav-item">
                                <div class="logo">
                                    <img class="img" src="assets/media/image-index/japan-evasion-logo.png" alt="logo japan-evasion">
                                </div>
                            </li>
