...
function loadData(callBackLoadData, area) {
    $.ajax("./?ajax=audience", {
        ...
        if (result.success) {
            $(area).html("<canvas id='myAreaChart'></canvas>");
...
function callBackLoadData(result) {
    ...
    var myLineChart = new Chart(ctx, {
        type: 'line',
        data: {
            labels: ["Jan", "Fev", "Mar", "Avr", "Mai", "Juin", "Jui", "Aout", "Sept", "Oct", "Nov", "Dec"],
            datasets: [{
                ...
                pointRadius: 3,
                pointBackgroundColor: "rgba(122, 10, 17, 1)",
                pointBorderColor: "rgba(122, 10, 17, 1)",
                pointHoverRadius: 3,
                pointHoverBackgroundColor: "rgba(122, 10, 17, 1)",
                pointHoverBorderColor: "rgba(122, 10, 17, 1)",
                pointHitRadius: 10,
                pointBorderWidth: 2,
                data: result['count'],
            }],
